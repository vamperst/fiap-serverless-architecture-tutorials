...
13. Execute o comando `git clone https://github.com/vamperst/fiap-serverless-architecture-tutorials.git` para clonar o repositório com os exercicios.
14. Execute o comando `cd fiap-serverless-architecture-tutorials/` para entrar na pasta criada pelo git
